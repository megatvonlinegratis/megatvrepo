...
##CONFIGURAÇÕES
####  TÍTULO DO MENU  #################################################################
title_menu = '[B][COLOR blue]:::[/COLOR][COLOR gold]BEM-VINDOS AO[/COLOR] [COLOR blue]MEGA[/COLOR][COLOR white]TV[/COLOR][COLOR blue]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = '[B][COLOR blue]Mega[/COLOR] [COLOR white]TV[/COLOR][/B] - [B][COLOR white]Os Melhores[/COLOR][/B] [B][COLOR gold]Conteúdos[/COLOR][/B] [B][COLOR white]em um só Lugar[/COLOR][/B].'

####  LINK DO TÍTULO DE MENU  #########################################################
...
thumb_icon_config = ''
desc_configuracoes = 'Configure o addon Mega TV conforme desejado Desativando ou ativando as notificações e muito mais.'
## FAVORITOS
menu_favoritos = '[B][COLOR white]FAVORITOS[/COLOR][/B]'
thumb_favoritos = ''
desc_favoritos = 'Adicione Itens aos Favoritos, pressionando OK do controle ou clicando o direito e selecionando Adicionar aos favoritos do Mega TV'
...
#### DESCRIÇÃO VIP ###########################################################
vip_descricao = ''
#### DIÁLOGO VIP - SERVIDOR DESATIVADO - CLICK ###################################
...
## MULTLINK
## nome para $texto, padrão: lsname para $lsname
playlist_command = 'texto'
dialog_playlist = '[B][COLOR blue]MEGA[/COLOR] [COLOR white]TV[/COLOR][/B] - [B][COLOR white]ESCOLHA UMA OPÇÃO[/COLOR][/B]'
...
#### LINK DO ARQUIVO DA BASE PRINCIPAL - BASE64 #######################################
url_b64_principal = ''
try:
    url_principal = base64.b64decode(url_b64_principal).decode('utf-8')
except:
    url_principal = url_b64_principal
    ...
    for item in items:
        ...
        try:
            ...
            ##Multilink
                ...
                name_resolve = name+'[B][COLOR gold] ('+str(len(url2))+' OPÇÕES)[/COLOR][/B]'
...
def SetView(name):
    ...
    if name == 'Fanart':
        try:
            ...
            pass            def mensagem_status():    try:	    ####  MENSAGEM DO STATUS - BASE 64 ##############################################################	        msg = ""        msg = base64.b64decode(msg).decode('utf-8')        line1 = getRequest3(msg,'')        time = 15000 #in miliseconds        xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%(__addonname__,line1, time, __icon__))    except:        pass            
